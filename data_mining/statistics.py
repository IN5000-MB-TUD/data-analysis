...
def update_repository_statistics_data(repository):
    """
    Retrieve and update the statistics data from the GitHub API for the given repository.
...
if __name__ == "__main__":
    ...
    for repository_data in repositories_data:
        if update_repository_statistics_data(repository_data):
            repos_counter += 1

    log.info(f"Successfully updated statistics for {repos_counter} repositories")
