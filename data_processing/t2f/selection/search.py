...
from data_processing.t2f.model.clustering import ClusterWrapper, cluster_metrics
...
def simple_grid_search(
    ...
    for new_params in tqdm(ParameterGrid(grid_params)):
        ...
        model = ClusterWrapper(
            model_type=model_type, transform_type=transform_type, n_clusters=num_labels
        )
